...
class Training_args(argparse.Namespace):
    ...
    lr = 1e-4
    weight_decay = 0.0
    lr_anneal_steps = 50   # 1000000
    microbatch = -1  # -1 disables microbatches
    log_interval = 10
    save_interval = 1e2 #5e3
    mmd_alpha = 0.0005
    save_dir = f"./OUTPUT/drinkeat_10080_{ts}/"
...
class Data_args(argparse.Namespace):
    name = "drinkeats2"
    proportion = 1.0
    data_root = "./dataset/drinkeat_10080_94u_train.csv"  # "./dataset/drinkeat_5040_94u_train.csv"
    window = 24
    save2npy = True
    neg_one_to_one = True
    seed = 123
