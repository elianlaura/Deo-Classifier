...
class Training_args(argparse.Namespace):
    ...
    lr = 1e-4
    weight_decay = 0.0
    lr_anneal_steps = 150000 #300000   # 2 1000000
    microbatch = -1  # -1 disables microbatches
    log_interval = 100
    save_interval = 5e3
    mmd_alpha = 0.0005
    save_dir = f"./OUTPUT/drinkeat_gru_{ts}/"
...
class Diffusion_args(argparse.Namespace):
    predict_xstart = True
    diffusion_steps = 300 # 500 #10 500
...
class Data_args(argparse.Namespace):
    name = "drinkeat"
    proportion = 1.0
    data_root = "./dataset/drinkeat_94u_train.csv"  # "./dataset/drinkeat_5040_94u_train.csv"
    window = 24
    save2npy = True
    neg_one_to_one = True
    seed = 123
