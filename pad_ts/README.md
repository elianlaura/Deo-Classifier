...
## Source and References (Deo-Classifier Integration)

This `pad_ts/` folder in Deo-Classifier is based on the original PaD-TS project.

- Original source repository: https://github.com/wmd3i/PaD-TS
- Original paper (arXiv): https://arxiv.org/abs/2501.00910
- Published paper (AAAI 2025): https://ojs.aaai.org/index.php/AAAI/article/view/34038
...
If you use this module from Deo-Classifier, please cite the PaD-TS work using the BibTeX entry below.
